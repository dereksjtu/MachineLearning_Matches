...
if __name__ == "__main__":
    ...
    #                            ]
    do_not_use_for_training = ['SaleDate','saleCount','Coupon','wkDaySaleCount_min','holDaySaleCount_min','dayOfYear','price_mean','price_median','dayOn6DayDiff','dayOn5DayDiff','dayOn7DayDiff','dayOn8DayDiff','dayOn21DayDiff',
                               'wkDaySaleCount_mean',
                               ]
    ...
    # diff_tr2te = np.setdiff1d(train_feat_1['Class'].unique(),test_feat_1['Class'].unique())
    # l_train = train_feat_1['Class'].unique()
    # l_train_feat_wanted = [f for f in l_train if f not in diff_tr2te]
    # train_feat_1 = train_feat_1[train_feat_1['Class'].isin(l_train_feat_wanted)]
    # print np.setdiff1d(train_feat_1['Class'].unique(),test_feat_1['Class'].unique())
